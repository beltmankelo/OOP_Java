...
class SeatsFilledException extends Exception{
	private int r;
	public SeatsFilledException(int r)
	{
		this.r=r;
	}
	public int getr()
...
class Student
{
	...
	static int c=0;
	final int size=2;
	void accept() throws SeatsFilledException
	{
		...
		this.r+=((g.get(Calendar.YEAR)%100))*100;
		if(this.r%100>25)
			throw new SeatsFilledException(this.r);
	}
	static int counter()
	{
		c++;
...
class Strings
{
	...
	public static void main(String[] args) {
		...
		for(i=0;i<sz;i++)
		{
			...
			{
				System.out.println("Exceeding registration number:"+exc.getr());
			}
		}
		System.out.println("Enter S-Sort w.r.t Sem and CGPA,O-Sort w.r.t name,L-List start character name,I-List substrings,C-Change name,D-Display");
		do
		{
